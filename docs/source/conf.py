...
# -*- coding: utf-8 -*-
#
# ipyspin documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyspin', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyspin.tex', 'ipyspin Documentation',
